...
@section('content')
			...
			<img class="pageBanner" src="themes/images/pageBanner.png" alt="New products" >
				<h4><span>Sản Phẩm {{$sanpham->tensp}}</span></h4>
			</section>
			<section class="main-content">				
				<div class="row">						
					<div class="span9">
						<div class="row">
							<div class="span4">
								<a href="themes/images/cloth/{{$sanpham->hinhanh}}" class="thumbnail" data-fancybox-group="group1" title="Description 1"><img alt="" src="themes/images/cloth/{{$sanpham->hinhanh}}"></a>												
							...
							<div class="span5">
								<address>
									...
									<strong>Điểm Thưởng:</strong> <span>0</span><br>
									<strong>Trạng Thái:</strong> <span>{{$sanpham->trangthai}}</span><br>								
								</address>									
								<h4><strong>Giá:{{$sanpham->giaban}}</strong></h4>
							</div>
							<div class="span5">
						...
						<div class="row">
							<div class="span9">
								...
								<div class="tab-content">
									<div class="tab-pane active" id="home">{{$sanpham->chitiet}}</div>
							...
							<div class="span9">	
								<br>
								<h4 class="title">
									<span class="pull-left"><span class="text"><strong>Sản Phẩm</strong> Tương Tự</span></span>
											...
											<ul class="thumbnails listing-products">
												...
												@foreach($sanphamtuongtu as $sptt)
													<div class="product-box">
														...
														<a href="product_detail.html"><img alt="" src="themes/images/cloth/{{$sptt->hinhanh}}"></a><br/>
														<a href="product_detail.html" class="title">{{$sptt->tensp}}</a><br/>
														<a href="#" class="category">{{$sptt->chitiet}}</a>
														<p class="price">{{$sptt->giaban}}</p>
													</div>
													@endforeach
												</li>
